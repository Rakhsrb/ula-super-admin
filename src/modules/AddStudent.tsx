...
export function AddStudent() {
  ...
  const validateForm = () => {
    ...
    if (!formData.firstName.trim()) {
      newErrors.fistName = "Полное имя обязательно.";
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await Fetch.post("student/register", formData);
  ...
  return (
    ...
    >
      <SheetTrigger asChild>
        <Button variant="default" className="bg-sky-600">Add Student</Button>
      </SheetTrigger>
      <SheetContent className="h-full w-full sm:max-w-md sm:h-auto bg-[#202020] text-white border-none">
        ...
        <SheetDescription>
          <span>Fill in all fields to create a student</span>
        </SheetDescription>
        <div className="flex flex-col gap-4 py-4">
          <div className="space-y-1">
            <Label htmlFor="firstName">
              ...
              <span
                className={`${
                  errors.firstName ? "text-red-500" : "text-blue-500"
                }`}
              >
                *
              </span>
          ...
          <div className="space-y-1">
            <Label htmlFor="lastName">
              ...
              <span
                className={`${
                  errors.lastName ? "text-red-500" : "text-blue-500"
                }`}
              >
                *
              </span>
